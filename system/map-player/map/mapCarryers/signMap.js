...
export class signMaker {
    ...
    constructSigns(){ 
        ...
        this.signs[5] = new sign(-19077, -2539 - 150,["              [go through that portal on the left]", "             [that will lead you to another hook]", "[that path is much harder than what you have done]", "                                 [good luck]", "", "                                                                              [- the travler]"])
        //-19077, -2539
