...
export class signMaker {
    ...
    constructSigns(){ 
        ...
        this.signs[6] = new sign(4392,9076,["{this is basically the end, there is a little bit more, but it's not done yet}", "{Hold down \\ and one of these keys for different debug features}", "{N; Noclip}", "{C; Coordenats}", "{SHIFT M; full map editor}", "{The Developer}"])
        this.signs[7] = new sign(3309 + 50,-2153 - 150,["{by the way, you can save and load}", "{CTRL C to save (copy it to a text file)}", "{CTRL V to load}", "{however, if you are on firefox you can't load}", "", "{The Developer}"])
