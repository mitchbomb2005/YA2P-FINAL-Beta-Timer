...
export class Death {
    ...
    #createHitboxes() {
        ...
        this.hitboxes[this.hitboxes.length] = new Hitbox(1068,-2489,463,61 ) // 30
        this.hitboxes[this.hitboxes.length] = new Hitbox(808,-2382,333,57 )
        this.hitboxes[this.hitboxes.length] = new Hitbox(1070,-2460,71,134 ) 
